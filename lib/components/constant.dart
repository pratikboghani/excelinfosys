...
List<TextEditingController> listqntControllers = [];
List<TextEditingController> listpriceControllers = [];
List<bool> listselecteditem = [];
List<String> iname = [];
List<String> iprice = [];
...
final image = pw.MemoryImage(
  File('images/logo.jpg').readAsBytesSync(),
);
var data = {
